 ...
 * apidoc:0.11.84 http://www.apidoc.me/flow/delta/0.3.92-dev/anorm_2_x_parsers
 */
import anorm._
...
package io.flow.delta.v0.anorm.parsers {
  ...
  object Version {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_") = parser(
      ...
      serviceName = s"$prefix${sep}service_name"
    )
    ...
    def parser(
      ...
      SqlParser.str(name) ~
      SqlParser.long(instances) ~
      SqlParser.str(serviceName).? map {
        case name ~ instances ~ serviceName => {
