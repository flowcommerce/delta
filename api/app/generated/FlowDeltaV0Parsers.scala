 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/delta/0.5.61-44-ge80aacf/anorm_2_6_parsers
 */
import anorm._
...
package io.flow.delta.v0.anorm.parsers {
  ...
  object Notification {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.delta.v0.models.Notification] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      messagePrefix: String = "Message",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.delta.v0.models.Notification] = {
      io.flow.delta.v0.anorm.parsers.SnsMessageAmiUpdate.parserWithPrefix(prefixOpt.getOrElse("") + messagePrefix) map {
        case Message => {
          io.flow.delta.v0.models.Notification(
            Message = Message
          )
        }
      }
  ...
  object SubscriptionConfirmation {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.delta.v0.models.SubscriptionConfirmation] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      SubscribeURL: String = "SubscribeURL",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.delta.v0.models.SubscriptionConfirmation] = {
      SqlParser.str(prefixOpt.getOrElse("") + SubscribeURL) map {
        case SubscribeURL => {
          io.flow.delta.v0.models.SubscriptionConfirmation(
  ...
  object SnsMessageAmiUpdate {

    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.delta.v0.models.SnsMessageAmiUpdate] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      eCSAmisPrefix: String = "ECSAmis",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.delta.v0.models.SnsMessageAmiUpdate] = {
      io.flow.delta.v0.anorm.parsers.EcsAmis.parserWithPrefix(prefixOpt.getOrElse("") + eCSAmisPrefix) map {
        case ECSAmis => {
          io.flow.delta.v0.models.SnsMessageAmiUpdate(
            ECSAmis = ECSAmis
          )
        }
      }
  ...
  object SnsMessageAmi {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_") = {
      io.flow.delta.v0.anorm.parsers.SubscriptionConfirmation.parser(prefixOpt = Some(s"$prefix$sep")) |
      io.flow.delta.v0.anorm.parsers.Notification.parser(prefixOpt = Some(s"$prefix$sep"))
    }

    def parser() = {
      io.flow.delta.v0.anorm.parsers.SubscriptionConfirmation.parser() |
      io.flow.delta.v0.anorm.parsers.Notification.parser()
    }
