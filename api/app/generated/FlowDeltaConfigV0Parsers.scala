 ...
 * apidoc:0.11.38 http://www.apidoc.me/flow/delta-config/0.2.61/anorm_2_x_parsers
 */
import anorm._
  ...
  object Build {
    ...
    def parser(
      ...
      SqlParser.get[Seq[String]](dependencies) map {
        case name ~ dockerfile ~ initialNumberInstances ~ instanceType ~ memory ~ portContainer ~ portHost ~ stages ~ dependencies => {
