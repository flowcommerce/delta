...
package io.flow.delta.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqDeltaNotification: Column[Seq[_root_.io.flow.delta.v0.models.Notification]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.Notification]] }
    implicit val columnToMapDeltaNotification: Column[Map[String, _root_.io.flow.delta.v0.models.Notification]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.Notification]] }
    implicit val columnToSeqDeltaSubscriptionConfirmation: Column[Seq[_root_.io.flow.delta.v0.models.SubscriptionConfirmation]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.SubscriptionConfirmation]] }
    implicit val columnToMapDeltaSubscriptionConfirmation: Column[Map[String, _root_.io.flow.delta.v0.models.SubscriptionConfirmation]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.SubscriptionConfirmation]] }
    ...
    implicit val columnToSeqDeltaSnsMessageAmiUpdate: Column[Seq[_root_.io.flow.delta.v0.models.SnsMessageAmiUpdate]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.SnsMessageAmiUpdate]] }
    implicit val columnToMapDeltaSnsMessageAmiUpdate: Column[Map[String, _root_.io.flow.delta.v0.models.SnsMessageAmiUpdate]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.SnsMessageAmiUpdate]] }
