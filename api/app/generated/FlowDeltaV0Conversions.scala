 ...
 * apidoc:0.11.38 http://www.apidoc.me/flow/delta/0.3.1/anorm_2_x_parsers
 */
package io.flow.delta.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqDeltaError: Column[Seq[_root_.io.flow.delta.v0.models.Error]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.Error]] }
    implicit val columnToMapDeltaError: Column[Map[String, _root_.io.flow.delta.v0.models.Error]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.Error]] }
