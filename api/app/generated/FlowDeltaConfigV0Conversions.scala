 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/delta-config/latest/anorm_2_6_parsers
 */
package io.flow.delta.config.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqDeltaConfigCluster: Column[Seq[_root_.io.flow.delta.config.v0.models.Cluster]] = Util.parser { _.as[Seq[_root_.io.flow.delta.config.v0.models.Cluster]] }
    implicit val columnToMapDeltaConfigCluster: Column[Map[String, _root_.io.flow.delta.config.v0.models.Cluster]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.config.v0.models.Cluster]] }
    ...
    implicit val columnToSeqDeltaConfigEcsBuildConfig: Column[Seq[_root_.io.flow.delta.config.v0.models.EcsBuildConfig]] = Util.parser { _.as[Seq[_root_.io.flow.delta.config.v0.models.EcsBuildConfig]] }
