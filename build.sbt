...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      jdbc,
      "com.amazonaws" % "aws-java-sdk-ec2" % "1.11.947",
      "com.amazonaws" % "aws-java-sdk-ecs" % "1.11.947",
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.947",
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % "1.11.947",
      "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.947",
      "com.amazonaws" % "aws-java-sdk-sns" % "1.11.947",
      "com.typesafe.play" %% "play-json-joda" % "2.9.2",
      "org.postgresql" % "postgresql" % "42.2.18",
      "com.sendgrid" %  "sendgrid-java" % "4.7.1",
      "io.flow" %% "lib-akka-akka26" % "0.1.43",
      "io.flow" %% "lib-event-play28" % "1.0.72",
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  ...
  libraryDependencies ++= Seq(
    ws,
    guice,
    "io.flow" %% "lib-play-play28" % "0.6.30",
