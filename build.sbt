...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.flow" %% "lib-event-play28" % "1.0.66",
      "io.flow" %% "lib-log" % "0.1.29",
      "io.flow" %% "lib-postgresql-play-play28" % "0.4.3",
      "io.flow" %% "lib-play-graphite-play28" % "0.1.77",
      "io.flow" %% "lib-usage-play28" % "0.1.46",
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "io.flow" %% "lib-test-utils-play28" % "0.1.17" % Test,
  ),
