...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.854",
      ...
      "io.flow" %% "lib-akka-akka26" % "0.1.28",
      "io.flow" %% "lib-event-play28" % "1.0.52",
      "io.flow" %% "lib-log" % "0.1.17",
      "io.flow" %% "lib-postgresql-play-play28" % "0.3.91",
      "io.flow" %% "lib-play-graphite-play28" % "0.1.56",
      "io.flow" %% "lib-usage-play28" % "0.1.32",
