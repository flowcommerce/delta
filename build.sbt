...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      jdbc,
      "com.amazonaws" % "aws-java-sdk-ec2" % "1.11.908",
      "com.amazonaws" % "aws-java-sdk-ecs" % "1.11.908",
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.908",
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % "1.11.908",
      "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.908",
      "com.amazonaws" % "aws-java-sdk-sns" % "1.11.908",
      "com.typesafe.play" %% "play-json-joda" % "2.9.1",
      "org.postgresql" % "postgresql" % "42.2.18",
      "com.sendgrid" %  "sendgrid-java" % "4.7.0",
      "io.flow" %% "lib-akka-akka26" % "0.1.36",
      "io.flow" %% "lib-event-play28" % "1.0.62",
      "io.flow" %% "lib-log" % "0.1.25",
      "io.flow" %% "lib-postgresql-play-play28" % "0.3.99",
