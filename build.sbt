...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      jdbc,
      "com.amazonaws" % "aws-java-sdk-ec2" % "1.11.929",
      "com.amazonaws" % "aws-java-sdk-ecs" % "1.11.929",
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.929",
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % "1.11.929",
      "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.929",
      "com.amazonaws" % "aws-java-sdk-sns" % "1.11.929",
      "com.typesafe.play" %% "play-json-joda" % "2.9.1",
      "org.postgresql" % "postgresql" % "42.2.18",
      "com.sendgrid" %  "sendgrid-java" % "4.7.1",
      "io.flow" %% "lib-akka-akka26" % "0.1.39",
      "io.flow" %% "lib-event-play28" % "1.0.65",
      "io.flow" %% "lib-log" % "0.1.28",
      "io.flow" %% "lib-postgresql-play-play28" % "0.4.2",
      "io.flow" %% "lib-play-graphite-play28" % "0.1.76",
      "io.flow" %% "lib-usage-play28" % "0.1.45",
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "io.flow" %% "lib-test-utils-play28" % "0.1.16" % Test,
  ),
