...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      jdbc,
      "com.amazonaws" % "aws-java-sdk-ec2" % "1.11.825",
      "com.amazonaws" % "aws-java-sdk-ecs" % "1.11.825",
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.826",
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % "1.11.825",
      "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.825",
      "com.amazonaws" % "aws-java-sdk-sns" % "1.11.825",
      "com.typesafe.play" %% "play-json-joda" % "2.9.0",
      "org.postgresql" % "postgresql" % "42.2.14",
      "com.sendgrid" %  "sendgrid-java" % "4.6.2",
      "io.flow" %% "lib-akka-akka26" % "0.1.26",
      "io.flow" %% "lib-event-play28" % "1.0.49",
      "io.flow" %% "lib-log" % "0.1.15",
      "io.flow" %% "lib-postgresql-play-play28" % "0.3.82",
      "io.flow" %% "lib-play-graphite-play28" % "0.1.54",
