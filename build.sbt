...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ws,
      jdbc,
      "io.flow" %% "lib-postgresql" % "0.0.41",
      "com.amazonaws" % "aws-java-sdk-ec2" % 1.11.70,
      "com.amazonaws" % "aws-java-sdk-ecs" % 1.11.70,
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % 1.11.70,
      "com.amazonaws" % "aws-java-sdk-autoscaling" % 1.11.70,
