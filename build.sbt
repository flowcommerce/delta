...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      jdbc,
      "com.amazonaws" % "aws-java-sdk-ec2" % "1.11.893",
      "com.amazonaws" % "aws-java-sdk-ecs" % "1.11.893",
      "com.amazonaws" % "aws-java-sdk-ecr" % "1.11.894",
      "com.amazonaws" % "aws-java-sdk-elasticloadbalancing" % "1.11.893",
      "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.893",
      "com.amazonaws" % "aws-java-sdk-sns" % "1.11.893",
      "com.typesafe.play" %% "play-json-joda" % "2.9.1",
      "org.postgresql" % "postgresql" % "42.2.18",
      "com.sendgrid" %  "sendgrid-java" % "4.6.7",
      "io.flow" %% "lib-akka-akka26" % "0.1.34",
      "io.flow" %% "lib-event-play28" % "1.0.60",
      "io.flow" %% "lib-log" % "0.1.23",
      "io.flow" %% "lib-postgresql-play-play28" % "0.3.97",
      "io.flow" %% "lib-play-graphite-play28" % "0.1.70",
      "io.flow" %% "lib-usage-play28" % "0.1.40",
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  ...
  libraryDependencies ++= Seq(
    ws,
    guice,
    "io.flow" %% "lib-play-play28" % "0.6.18",
    "io.flow" %% "lib-test-utils-play28" % "0.1.9" % Test,
  ),
