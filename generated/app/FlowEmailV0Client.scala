 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/email/latest/play_2_6_client
 */
...
package io.flow.email.v0.models {
  ...
  package object json {
    ...
    def jsObjectAmiUpdateNotification(obj: io.flow.email.v0.models.AmiUpdateNotification): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "ami_update_notification")
    }

    implicit def jsonWritesEmailAmiUpdateNotification: play.api.libs.json.Writes[AmiUpdateNotification] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.AmiUpdateNotification] {
        def writes(obj: io.flow.email.v0.models.AmiUpdateNotification) = {
          jsObjectAmiUpdateNotification(obj)
        }
      }
    }
    ...
    def jsObjectBillingFlowDailySummary(obj: io.flow.email.v0.models.BillingFlowDailySummary): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "billing_flow_daily_summary")
    }

    implicit def jsonWritesEmailBillingFlowDailySummary: play.api.libs.json.Writes[BillingFlowDailySummary] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.BillingFlowDailySummary] {
        def writes(obj: io.flow.email.v0.models.BillingFlowDailySummary) = {
          jsObjectBillingFlowDailySummary(obj)
        }
      }
    }
    ...
    def jsObjectBillingStatement(obj: io.flow.email.v0.models.BillingStatement): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "billing_statement")
    }

    implicit def jsonWritesEmailBillingStatement: play.api.libs.json.Writes[BillingStatement] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.BillingStatement] {
        def writes(obj: io.flow.email.v0.models.BillingStatement) = {
          jsObjectBillingStatement(obj)
        }
      }
    }
    ...
    def jsObjectBillingUpcomingSubscriptions(obj: io.flow.email.v0.models.BillingUpcomingSubscriptions): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "billing_upcoming_subscriptions")
    }

    implicit def jsonWritesEmailBillingUpcomingSubscriptions: play.api.libs.json.Writes[BillingUpcomingSubscriptions] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.BillingUpcomingSubscriptions] {
        def writes(obj: io.flow.email.v0.models.BillingUpcomingSubscriptions) = {
          jsObjectBillingUpcomingSubscriptions(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseOrderCancelCustomerRequest(obj: io.flow.email.v0.models.CanadaGooseOrderCancelCustomerRequest): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_order_cancel_customer_request")
    }

    implicit def jsonWritesEmailCanadaGooseOrderCancelCustomerRequest: play.api.libs.json.Writes[CanadaGooseOrderCancelCustomerRequest] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseOrderCancelCustomerRequest] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseOrderCancelCustomerRequest) = {
          jsObjectCanadaGooseOrderCancelCustomerRequest(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseOrderCancelFlow(obj: io.flow.email.v0.models.CanadaGooseOrderCancelFlow): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "common_fields" -> jsObjectCanadaGooseCommon(obj.commonFields)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_order_cancel_flow")
    }

    implicit def jsonWritesEmailCanadaGooseOrderCancelFlow: play.api.libs.json.Writes[CanadaGooseOrderCancelFlow] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseOrderCancelFlow] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseOrderCancelFlow) = {
          jsObjectCanadaGooseOrderCancelFlow(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseOrderCancelInvalidPayment(obj: io.flow.email.v0.models.CanadaGooseOrderCancelInvalidPayment): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "common_fields" -> jsObjectCanadaGooseCommon(obj.commonFields)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_order_cancel_invalid_payment")
    }

    implicit def jsonWritesEmailCanadaGooseOrderCancelInvalidPayment: play.api.libs.json.Writes[CanadaGooseOrderCancelInvalidPayment] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseOrderCancelInvalidPayment] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseOrderCancelInvalidPayment) = {
          jsObjectCanadaGooseOrderCancelInvalidPayment(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseOrderCancelOutOfStock(obj: io.flow.email.v0.models.CanadaGooseOrderCancelOutOfStock): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "common_fields" -> jsObjectCanadaGooseCommon(obj.commonFields)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_order_cancel_out_of_stock")
    }

    implicit def jsonWritesEmailCanadaGooseOrderCancelOutOfStock: play.api.libs.json.Writes[CanadaGooseOrderCancelOutOfStock] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseOrderCancelOutOfStock] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseOrderCancelOutOfStock) = {
          jsObjectCanadaGooseOrderCancelOutOfStock(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseOrderConfirmation(obj: io.flow.email.v0.models.CanadaGooseOrderConfirmation): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "common_fields" -> jsObjectCanadaGooseCommon(obj.commonFields)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_order_confirmation")
    }

    implicit def jsonWritesEmailCanadaGooseOrderConfirmation: play.api.libs.json.Writes[CanadaGooseOrderConfirmation] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseOrderConfirmation] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseOrderConfirmation) = {
          jsObjectCanadaGooseOrderConfirmation(obj)
        }
      }
    }
    ...
    def jsObjectCanadaGooseShipmentConfirmation(obj: io.flow.email.v0.models.CanadaGooseShipmentConfirmation): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "common_fields" -> jsObjectCanadaGooseCommon(obj.commonFields)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "canada_goose_shipment_confirmation")
    }

    implicit def jsonWritesEmailCanadaGooseShipmentConfirmation: play.api.libs.json.Writes[CanadaGooseShipmentConfirmation] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CanadaGooseShipmentConfirmation] {
        def writes(obj: io.flow.email.v0.models.CanadaGooseShipmentConfirmation) = {
          jsObjectCanadaGooseShipmentConfirmation(obj)
        }
      }
    }
    ...
    def jsObjectCustomerFulfillmentConfirmation(obj: io.flow.email.v0.models.CustomerFulfillmentConfirmation): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "customer_fulfillment_confirmation")
    }

    implicit def jsonWritesEmailCustomerFulfillmentConfirmation: play.api.libs.json.Writes[CustomerFulfillmentConfirmation] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CustomerFulfillmentConfirmation] {
        def writes(obj: io.flow.email.v0.models.CustomerFulfillmentConfirmation) = {
          jsObjectCustomerFulfillmentConfirmation(obj)
        }
      }
    }
    ...
    def jsObjectCustomerOrderConfirmation(obj: io.flow.email.v0.models.CustomerOrderConfirmation): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "order" -> io.flow.experience.v0.models.json.jsObjectOrder(obj.order),
        "items" -> play.api.libs.json.Json.toJson(obj.items)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "customer_order_confirmation")
    }

    implicit def jsonWritesEmailCustomerOrderConfirmation: play.api.libs.json.Writes[CustomerOrderConfirmation] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CustomerOrderConfirmation] {
        def writes(obj: io.flow.email.v0.models.CustomerOrderConfirmation) = {
          jsObjectCustomerOrderConfirmation(obj)
        }
      }
    }
    ...
    def jsObjectCustomsIdentificationEmail(obj: io.flow.email.v0.models.CustomsIdentificationEmail): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "customs_identification_email")
    }

    implicit def jsonWritesEmailCustomsIdentificationEmail: play.api.libs.json.Writes[CustomsIdentificationEmail] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.CustomsIdentificationEmail] {
        def writes(obj: io.flow.email.v0.models.CustomsIdentificationEmail) = {
          jsObjectCustomsIdentificationEmail(obj)
        }
      }
    }
    ...
    def jsObjectEmailMessage(obj: io.flow.email.v0.models.EmailMessage): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "email_message")
    }

    implicit def jsonWritesEmailEmailMessage: play.api.libs.json.Writes[EmailMessage] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.EmailMessage] {
        def writes(obj: io.flow.email.v0.models.EmailMessage) = {
    ...
    def jsObjectExportCompleted(obj: io.flow.email.v0.models.ExportCompleted): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "export_completed")
    }

    implicit def jsonWritesEmailExportCompleted: play.api.libs.json.Writes[ExportCompleted] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.ExportCompleted] {
        def writes(obj: io.flow.email.v0.models.ExportCompleted) = {
          jsObjectExportCompleted(obj)
        }
      }
    }
    ...
    def jsObjectExportFailed(obj: io.flow.email.v0.models.ExportFailed): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.JsString(x))
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "export_failed")
    }

    implicit def jsonWritesEmailExportFailed: play.api.libs.json.Writes[ExportFailed] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.ExportFailed] {
        def writes(obj: io.flow.email.v0.models.ExportFailed) = {
          jsObjectExportFailed(obj)
        }
      }
    }
    ...
    def jsObjectFeedErrorsDetected(obj: io.flow.email.v0.models.FeedErrorsDetected): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "email" -> play.api.libs.json.JsString(obj.email),
        "url" -> play.api.libs.json.JsString(obj.url)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "feed_errors_detected")
    }

    implicit def jsonWritesEmailFeedErrorsDetected: play.api.libs.json.Writes[FeedErrorsDetected] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.FeedErrorsDetected] {
        def writes(obj: io.flow.email.v0.models.FeedErrorsDetected) = {
          jsObjectFeedErrorsDetected(obj)
        }
      }
    }
    ...
    def jsObjectFraudPendingReviewCreated(obj: io.flow.email.v0.models.FraudPendingReviewCreated): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "fraud_pending_review_created")
    }

    implicit def jsonWritesEmailFraudPendingReviewCreated: play.api.libs.json.Writes[FraudPendingReviewCreated] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.FraudPendingReviewCreated] {
        def writes(obj: io.flow.email.v0.models.FraudPendingReviewCreated) = {
          jsObjectFraudPendingReviewCreated(obj)
        }
      }
    }
    ...
    def jsObjectImportCompleted(obj: io.flow.email.v0.models.ImportCompleted): play.api.libs.json.JsObject = {
      ...
      (obj.description match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.JsString(x))
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "import_completed")
    }

    implicit def jsonWritesEmailImportCompleted: play.api.libs.json.Writes[ImportCompleted] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.ImportCompleted] {
        def writes(obj: io.flow.email.v0.models.ImportCompleted) = {
          jsObjectImportCompleted(obj)
        }
      }
    }
    ...
    def jsObjectImportFailed(obj: io.flow.email.v0.models.ImportFailed): play.api.libs.json.JsObject = {
      ...
      (obj.description match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.JsString(x))
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "import_failed")
    }

    implicit def jsonWritesEmailImportFailed: play.api.libs.json.Writes[ImportFailed] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.ImportFailed] {
        def writes(obj: io.flow.email.v0.models.ImportFailed) = {
          jsObjectImportFailed(obj)
        }
      }
    }
    ...
    def jsObjectInternalOrderPlacement(obj: io.flow.email.v0.models.InternalOrderPlacement): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "items" -> play.api.libs.json.Json.toJson(obj.items)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "internal_order_placement")
    }

    implicit def jsonWritesEmailInternalOrderPlacement: play.api.libs.json.Writes[InternalOrderPlacement] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.InternalOrderPlacement] {
        def writes(obj: io.flow.email.v0.models.InternalOrderPlacement) = {
          jsObjectInternalOrderPlacement(obj)
        }
      }
    }
    ...
    def jsObjectLabelAutogenerationFailureEmail(obj: io.flow.email.v0.models.LabelAutogenerationFailureEmail): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "label_autogeneration_failure_email")
    }

    implicit def jsonWritesEmailLabelAutogenerationFailureEmail: play.api.libs.json.Writes[LabelAutogenerationFailureEmail] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.LabelAutogenerationFailureEmail] {
        def writes(obj: io.flow.email.v0.models.LabelAutogenerationFailureEmail) = {
          jsObjectLabelAutogenerationFailureEmail(obj)
        }
      }
    }
    ...
    def jsObjectLabelAutogenerationFailuresReport(obj: io.flow.email.v0.models.LabelAutogenerationFailuresReport): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "to" -> play.api.libs.json.Json.toJson(obj.to),
        "attachments" -> play.api.libs.json.Json.toJson(obj.attachments)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "label_autogeneration_failures_report")
    }

    implicit def jsonWritesEmailLabelAutogenerationFailuresReport: play.api.libs.json.Writes[LabelAutogenerationFailuresReport] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.LabelAutogenerationFailuresReport] {
        def writes(obj: io.flow.email.v0.models.LabelAutogenerationFailuresReport) = {
          jsObjectLabelAutogenerationFailuresReport(obj)
        }
      }
    }
    ...
    def jsObjectLabelGenerated(obj: io.flow.email.v0.models.LabelGenerated): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "url" -> play.api.libs.json.JsString(obj.url)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "label_generated")
    }

    implicit def jsonWritesEmailLabelGenerated: play.api.libs.json.Writes[LabelGenerated] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.LabelGenerated] {
        def writes(obj: io.flow.email.v0.models.LabelGenerated) = {
          jsObjectLabelGenerated(obj)
        }
      }
    }
    ...
    def jsObjectOrderManagementReport(obj: io.flow.email.v0.models.OrderManagementReport): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "bcc" -> play.api.libs.json.Json.toJson(obj.bcc),
        "attachments" -> play.api.libs.json.Json.toJson(obj.attachments)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "order_management_report")
    }

    implicit def jsonWritesEmailOrderManagementReport: play.api.libs.json.Writes[OrderManagementReport] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.OrderManagementReport] {
        def writes(obj: io.flow.email.v0.models.OrderManagementReport) = {
          jsObjectOrderManagementReport(obj)
        }
      }
    }
    ...
    def jsObjectOrganizationInvitation(obj: io.flow.email.v0.models.OrganizationInvitation): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "organization_invitation")
    }

    implicit def jsonWritesEmailOrganizationInvitation: play.api.libs.json.Writes[OrganizationInvitation] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.OrganizationInvitation] {
        def writes(obj: io.flow.email.v0.models.OrganizationInvitation) = {
          jsObjectOrganizationInvitation(obj)
        }
      }
    }
    ...
    def jsObjectTaxReportGenerated(obj: io.flow.email.v0.models.TaxReportGenerated): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "tax_report_generated")
    }

    implicit def jsonWritesEmailTaxReportGenerated: play.api.libs.json.Writes[TaxReportGenerated] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.TaxReportGenerated] {
        def writes(obj: io.flow.email.v0.models.TaxReportGenerated) = {
          jsObjectTaxReportGenerated(obj)
        }
      }
    }
    ...
    def jsObjectUserActivated(obj: io.flow.email.v0.models.UserActivated): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "email" -> play.api.libs.json.JsString(obj.email)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "user_activated")
    }

    implicit def jsonWritesEmailUserActivated: play.api.libs.json.Writes[UserActivated] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserActivated] {
        def writes(obj: io.flow.email.v0.models.UserActivated) = {
          jsObjectUserActivated(obj)
        }
      }
    }
    ...
    def jsObjectUserEmailChanged(obj: io.flow.email.v0.models.UserEmailChanged): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "user_email_changed")
    }

    implicit def jsonWritesEmailUserEmailChanged: play.api.libs.json.Writes[UserEmailChanged] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserEmailChanged] {
        def writes(obj: io.flow.email.v0.models.UserEmailChanged) = {
          jsObjectUserEmailChanged(obj)
        }
      }
    }
    ...
    def jsObjectUserPasswordChanged(obj: io.flow.email.v0.models.UserPasswordChanged): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "email" -> play.api.libs.json.JsString(obj.email)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "user_password_changed")
    }

    implicit def jsonWritesEmailUserPasswordChanged: play.api.libs.json.Writes[UserPasswordChanged] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserPasswordChanged] {
        def writes(obj: io.flow.email.v0.models.UserPasswordChanged) = {
          jsObjectUserPasswordChanged(obj)
        }
      }
    }
    ...
    def jsObjectUserPasswordReset(obj: io.flow.email.v0.models.UserPasswordReset): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "token" -> play.api.libs.json.JsString(obj.token),
        "email" -> play.api.libs.json.JsString(obj.email)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "user_password_reset")
    }

    implicit def jsonWritesEmailUserPasswordReset: play.api.libs.json.Writes[UserPasswordReset] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserPasswordReset] {
        def writes(obj: io.flow.email.v0.models.UserPasswordReset) = {
          jsObjectUserPasswordReset(obj)
        }
      }
    }
    ...
    def jsObjectUserPendingCreated(obj: io.flow.email.v0.models.UserPendingCreated): play.api.libs.json.JsObject = {
      ...
      (obj.lastName match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("last_name" -> play.api.libs.json.JsString(x))
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "user_pending_created")
    }

    implicit def jsonWritesEmailUserPendingCreated: play.api.libs.json.Writes[UserPendingCreated] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserPendingCreated] {
        def writes(obj: io.flow.email.v0.models.UserPendingCreated) = {
          jsObjectUserPendingCreated(obj)
        }
      }
    }
    ...
    def jsObjectUserVerifyEmail(obj: io.flow.email.v0.models.UserVerifyEmail): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "token" -> play.api.libs.json.JsString(obj.token),
        "email" -> play.api.libs.json.JsString(obj.email)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "user_verify_email")
    }

    implicit def jsonWritesEmailUserVerifyEmail: play.api.libs.json.Writes[UserVerifyEmail] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.UserVerifyEmail] {
        def writes(obj: io.flow.email.v0.models.UserVerifyEmail) = {
          jsObjectUserVerifyEmail(obj)
        }
      }
    }
    ...
    def jsObjectEmail(obj: io.flow.email.v0.models.Email): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.email.v0.models.EmailMessage => jsObjectEmailMessage(x)
        case x: io.flow.email.v0.models.LabelGenerated => jsObjectLabelGenerated(x)
        case x: io.flow.email.v0.models.ExportCompleted => jsObjectExportCompleted(x)
        case x: io.flow.email.v0.models.ExportFailed => jsObjectExportFailed(x)
        case x: io.flow.email.v0.models.ImportCompleted => jsObjectImportCompleted(x)
        case x: io.flow.email.v0.models.ImportFailed => jsObjectImportFailed(x)
        case x: io.flow.email.v0.models.BillingStatement => jsObjectBillingStatement(x)
        case x: io.flow.email.v0.models.BillingFlowDailySummary => jsObjectBillingFlowDailySummary(x)
        case x: io.flow.email.v0.models.BillingUpcomingSubscriptions => jsObjectBillingUpcomingSubscriptions(x)
        case x: io.flow.email.v0.models.FraudPendingReviewCreated => jsObjectFraudPendingReviewCreated(x)
        case x: io.flow.email.v0.models.OrganizationInvitation => jsObjectOrganizationInvitation(x)
        case x: io.flow.email.v0.models.UserActivated => jsObjectUserActivated(x)
        case x: io.flow.email.v0.models.UserEmailChanged => jsObjectUserEmailChanged(x)
        case x: io.flow.email.v0.models.UserPasswordChanged => jsObjectUserPasswordChanged(x)
        case x: io.flow.email.v0.models.UserPasswordReset => jsObjectUserPasswordReset(x)
        case x: io.flow.email.v0.models.UserPendingCreated => jsObjectUserPendingCreated(x)
        case x: io.flow.email.v0.models.UserVerifyEmail => jsObjectUserVerifyEmail(x)
        case x: io.flow.email.v0.models.FeedErrorsDetected => jsObjectFeedErrorsDetected(x)
        case x: io.flow.email.v0.models.OrderManagementReport => jsObjectOrderManagementReport(x)
        case x: io.flow.email.v0.models.CustomsIdentificationEmail => jsObjectCustomsIdentificationEmail(x)
        case x: io.flow.email.v0.models.CanadaGooseOrderConfirmation => jsObjectCanadaGooseOrderConfirmation(x)
        case x: io.flow.email.v0.models.CanadaGooseShipmentConfirmation => jsObjectCanadaGooseShipmentConfirmation(x)
        case x: io.flow.email.v0.models.CanadaGooseOrderCancelOutOfStock => jsObjectCanadaGooseOrderCancelOutOfStock(x)
        case x: io.flow.email.v0.models.CanadaGooseOrderCancelCustomerRequest => jsObjectCanadaGooseOrderCancelCustomerRequest(x)
        case x: io.flow.email.v0.models.CanadaGooseOrderCancelFlow => jsObjectCanadaGooseOrderCancelFlow(x)
        case x: io.flow.email.v0.models.CanadaGooseOrderCancelInvalidPayment => jsObjectCanadaGooseOrderCancelInvalidPayment(x)
        case x: io.flow.email.v0.models.AmiUpdateNotification => jsObjectAmiUpdateNotification(x)
        case x: io.flow.email.v0.models.InternalOrderPlacement => jsObjectInternalOrderPlacement(x)
        case x: io.flow.email.v0.models.TaxReportGenerated => jsObjectTaxReportGenerated(x)
        case x: io.flow.email.v0.models.CustomerOrderConfirmation => jsObjectCustomerOrderConfirmation(x)
        case x: io.flow.email.v0.models.CustomerFulfillmentConfirmation => jsObjectCustomerFulfillmentConfirmation(x)
        case x: io.flow.email.v0.models.LabelAutogenerationFailuresReport => jsObjectLabelAutogenerationFailuresReport(x)
        case x: io.flow.email.v0.models.LabelAutogenerationFailureEmail => jsObjectLabelAutogenerationFailureEmail(x)
        case other => {
...
package io.flow.email.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/email/latest/play_2_6_client"
    val Version = "0.6.100"
    val VersionMajor = 0
