 ...
 * apibuilder 0.14.89 app.apibuilder.io/flow/email/latest/play_2_6_client
 */
...
package io.flow.email.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.89 app.apibuilder.io/flow/email/latest/play_2_6_client"
    val Version = "0.6.100"
    val VersionMajor = 0
