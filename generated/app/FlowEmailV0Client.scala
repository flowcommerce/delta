 ...
 * Service version: 0.6.9
 * apibuilder 0.15.11 app.apibuilder.io/flow/email/0.6.9/play_2_8_client
 */
...
package io.flow.email.v0.models {
  ...
  package object json {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "tula_email_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.email.v0.models.TulaEmailType(v))
    ...
    def jsObjectReportError(obj: io.flow.email.v0.models.ReportError): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "report_error")
    }

    implicit def jsonWritesEmailReportError: play.api.libs.json.Writes[ReportError] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.ReportError] {
        def writes(obj: io.flow.email.v0.models.ReportError) = {
          jsObjectReportError(obj)
        }
      }
    }
    ...
    def jsObjectTulaEmail(obj: io.flow.email.v0.models.TulaEmail): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "tula_email")
    }

    implicit def jsonWritesEmailTulaEmail: play.api.libs.json.Writes[TulaEmail] = {
      new play.api.libs.json.Writes[io.flow.email.v0.models.TulaEmail] {
        def writes(obj: io.flow.email.v0.models.TulaEmail) = {
          jsObjectTulaEmail(obj)
        }
      }
    }
    ...
    def jsObjectEmail(obj: io.flow.email.v0.models.Email): play.api.libs.json.JsObject = {
      obj match {
        ...
        case x: io.flow.email.v0.models.TulaEmail => jsObjectTulaEmail(x)
    ...
    def jsObjectReport(obj: io.flow.email.v0.models.Report): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.email.v0.models.ReportError => jsObjectReportError(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
...
package io.flow.email.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.11 app.apibuilder.io/flow/email/0.6.9/play_2_8_client"
    val Version = "0.6.9"
    val VersionMajor = 0
