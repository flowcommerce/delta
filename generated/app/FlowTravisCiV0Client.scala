 ...
 * apibuilder:0.12.20 https://app.apibuilder.io/flow/travis-ci/0.0.7/play_2_4_client
 */
package io.flow.travis.ci.v0.models {
  ...
  object EventType {
     ...
     * above.
     */
    val all = Seq(Api, PullRequest, Push)
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.20 https://app.apibuilder.io/flow/travis-ci/0.0.7/play_2_4_client"
    val Version = "0.0.7"
    val VersionMajor = 0
  ...
  trait Requests {
     ...
     * @param offset How many requests to skip before the first entry in the response.
     * Used for pagination.
     */
    def get(
      repositorySlug: String,
