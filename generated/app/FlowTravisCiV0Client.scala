 ...
 * apibuilder 0.15.8 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client
 */
package io.flow.travis.ci.v0.models {
  ...
  final case class RequestConfigData(
    ...
    jobs: _root_.scala.Option[io.flow.travis.ci.v0.models.RequestConfigJobsData] = None,
    stages: _root_.scala.Option[Seq[String]] = None
  )

  final case class RequestConfigJobsData(
    include: _root_.scala.Option[Seq[io.flow.travis.ci.v0.models.RequestConfigJobsIncludeData]] = None
  )

  final case class RequestConfigJobsIncludeData(
    script: String,
    name: _root_.scala.Option[String] = None,
    stage: _root_.scala.Option[String] = None
  )
  ...
  package object json {
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "merge_mode").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.travis.ci.v0.models.MergeMode(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    implicit def jsonReadsTravisCiRequestConfigData: play.api.libs.json.Reads[RequestConfigData] = {
      for {
        ...
        jobs <- (__ \ "jobs").readNullable[io.flow.travis.ci.v0.models.RequestConfigJobsData]
        stages <- (__ \ "stages").readNullable[Seq[String]]
      } yield RequestConfigData(language, dist, env, sudo, services, addons, beforeInstall, install, beforeScript, script, beforeCache, cache, afterSuccess, afterFailure, beforeDeploy, deploy, afterDeploy, afterScript, branches, jobs, stages)
    }
    ...
    def jsObjectRequestConfigData(obj: io.flow.travis.ci.v0.models.RequestConfigData): play.api.libs.json.JsObject = {
      ...
      (obj.jobs match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("jobs" -> jsObjectRequestConfigJobsData(x))
      }) ++
      (obj.stages match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("stages" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    implicit def jsonReadsTravisCiRequestConfigJobsData: play.api.libs.json.Reads[RequestConfigJobsData] = {
      (__ \ "include").readNullable[Seq[io.flow.travis.ci.v0.models.RequestConfigJobsIncludeData]].map { x => new RequestConfigJobsData(include = x) }
    }

    def jsObjectRequestConfigJobsData(obj: io.flow.travis.ci.v0.models.RequestConfigJobsData): play.api.libs.json.JsObject = {
      (obj.include match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("include" -> play.api.libs.json.Json.toJson(x))
      })
    }

    implicit def jsonWritesTravisCiRequestConfigJobsData: play.api.libs.json.Writes[RequestConfigJobsData] = {
      new play.api.libs.json.Writes[io.flow.travis.ci.v0.models.RequestConfigJobsData] {
        def writes(obj: io.flow.travis.ci.v0.models.RequestConfigJobsData) = {
          jsObjectRequestConfigJobsData(obj)
        }
      }
    }

    implicit def jsonReadsTravisCiRequestConfigJobsIncludeData: play.api.libs.json.Reads[RequestConfigJobsIncludeData] = {
      for {
        script <- (__ \ "script").read[String]
        name <- (__ \ "name").readNullable[String]
        stage <- (__ \ "stage").readNullable[String]
      } yield RequestConfigJobsIncludeData(script, name, stage)
    }

    def jsObjectRequestConfigJobsIncludeData(obj: io.flow.travis.ci.v0.models.RequestConfigJobsIncludeData): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
      ...
      (obj.stage match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("stage" -> play.api.libs.json.JsString(x))
      })
    }

    implicit def jsonWritesTravisCiRequestConfigJobsIncludeData: play.api.libs.json.Writes[RequestConfigJobsIncludeData] = {
      new play.api.libs.json.Writes[io.flow.travis.ci.v0.models.RequestConfigJobsIncludeData] {
        def writes(obj: io.flow.travis.ci.v0.models.RequestConfigJobsIncludeData) = {
          jsObjectRequestConfigJobsIncludeData(obj)
        }
      }
    }
    ...
    implicit def jsonReadsTravisCiRequestPostFormData: play.api.libs.json.Reads[RequestPostFormData] = {
      for {
        ...
        config <- (__ \ "config").read[io.flow.travis.ci.v0.models.RequestConfigData]
      } yield RequestPostFormData(branch, message, mergeMode, config)
    }
    ...
    implicit def jsonReadsTravisCiRequestRepositoryData: play.api.libs.json.Reads[RequestRepositoryData] = {
      ...
      } yield RequestRepositoryData(name, ownerName, slug)
    }
    ...
    implicit def jsonReadsTravisCiRequestRepositoryGetData: play.api.libs.json.Reads[RequestRepositoryGetData] = {
      for {
        ...
        eventType <- (__ \ "event_type").read[io.flow.travis.ci.v0.models.EventType]
      } yield RequestRepositoryGetData(id, state, result, message, branchName, commit, builds, owner, createdAt, eventType)
    }
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.8 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client"
    val Version = "0.2.18"
    val VersionMajor = 0
