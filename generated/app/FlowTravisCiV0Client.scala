 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client
 */
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client"
    val Version = "0.2.12"
    val VersionMajor = 0
