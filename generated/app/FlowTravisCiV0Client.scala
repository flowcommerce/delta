 ...
 * apibuilder 0.14.96 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client
 */
...
package io.flow.travis.ci.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsTravisCiRequestConfigData: play.api.libs.json.Reads[RequestConfigData] = {
      ...
      } yield RequestConfigData(mergeMode, language, dist, env, sudo, services, addons, beforeInstall, install, beforeScript, script, beforeCache, cache, afterSuccess, afterFailure, beforeDeploy, deploy, afterDeploy, afterScript, branches, jobs, stages)
    }
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.96 app.apibuilder.io/flow/travis-ci/latest/play_2_8_client"
    val Version = "0.2.12"
    val VersionMajor = 0
