 ...
 * apibuilder 0.14.91 app.apibuilder.io/flow/travis-ci/latest/play_2_6_client
 */
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.91 app.apibuilder.io/flow/travis-ci/latest/play_2_6_client"
    val Version = "0.2.12"
    val VersionMajor = 0
