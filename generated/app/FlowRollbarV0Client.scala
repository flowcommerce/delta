 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/rollbar/0.2.3/play_2_6_client
 */
...
package io.flow.rollbar.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/rollbar/0.2.3/play_2_6_client"
    val Version = "0.2.3"
    val VersionMajor = 0
