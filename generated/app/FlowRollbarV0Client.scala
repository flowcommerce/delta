 ...
 * apibuilder 0.15.6 app.apibuilder.io/flow/rollbar/latest/play_2_8_client
 */
...
package io.flow.rollbar.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.6 app.apibuilder.io/flow/rollbar/latest/play_2_8_client"
    val Version = "0.2.16"
    val VersionMajor = 0
