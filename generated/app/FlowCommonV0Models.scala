 ...
 * Service version: 0.9.64
 * apibuilder 0.15.11 app.apibuilder.io/flow/common/latest/play_2_x_json
 */
package io.flow.common.v0.models {
  ...
  object GoodsSupply {
     ...
     */
    case object Export extends GoodsSupply { override def toString = "export" }
    /**
     * Goods will be supplied from a DC outside the national boundries of the
     * destination, but within the same customs union.
     */
    case object IntraCommunity extends GoodsSupply { override def toString = "intra_community" }
    /**
     * Goods will be supplied from a DC within the same country as the destination.
     */
    case object Local extends GoodsSupply { override def toString = "local" }
...
package io.flow.common.v0.models {
  ...
  package object json {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "attribute_data_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.AttributeDataType(v))
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "availability_status").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.AvailabilityStatus(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "calendar").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.Calendar(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "capability").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.Capability(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "change_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ChangeType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "currency_label_formatter").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.CurrencyLabelFormatter(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "currency_symbol_format").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.CurrencySymbolFormat(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "day_of_week").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.DayOfWeek(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "delivered_duty").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.DeliveredDuty(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "discount_target").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.DiscountTarget(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "environment").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.Environment(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "exception_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ExceptionType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    implicit val jsonReadsCommonGoodsSupply = new play.api.libs.json.Reads[io.flow.common.v0.models.GoodsSupply] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.common.v0.models.GoodsSupply] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.common.v0.models.GoodsSupply(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.GoodsSupply(v))
              case err: play.api.libs.json.JsError =>
                (js \ "goods_supply").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.GoodsSupply(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsonWritesCommonGoodsSupply(obj: io.flow.common.v0.models.GoodsSupply) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectGoodsSupply(obj: io.flow.common.v0.models.GoodsSupply) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesCommonGoodsSupply: play.api.libs.json.Writes[GoodsSupply] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.GoodsSupply] {
        def writes(obj: io.flow.common.v0.models.GoodsSupply) = {
          jsonWritesCommonGoodsSupply(obj)
        }
      }
    }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "holiday_calendar").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.HolidayCalendar(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "included_levy_key").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.IncludedLevyKey(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "incoterm").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.Incoterm(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "input_specification_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.InputSpecificationType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "margin_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.MarginType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "measurement_system").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.MeasurementSystem(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "merchant_of_record").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.MerchantOfRecord(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "order_merchant_of_record").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrderMerchantOfRecord(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "price_book_status").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.PriceBookStatus(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "rounding_method").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.RoundingMethod(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "rounding_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.RoundingType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "schedule_exception_status").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ScheduleExceptionStatus(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "sort_direction").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.SortDirection(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "unit_of_measurement").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.UnitOfMeasurement(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "unit_of_time").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.UnitOfTime(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "value_added_service").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ValueAddedService(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    implicit def jsonReadsCommonCheckoutReference: play.api.libs.json.Reads[CheckoutReference] = {
      (__ \ "id").read[String].map { x => new CheckoutReference(id = x) }
    }

    def jsObjectCheckoutReference(obj: io.flow.common.v0.models.CheckoutReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesCommonCheckoutReference: play.api.libs.json.Writes[CheckoutReference] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.CheckoutReference] {
        def writes(obj: io.flow.common.v0.models.CheckoutReference) = {
          jsObjectCheckoutReference(obj)
        }
      }
    }
    ...
    def jsObjectDiscountOfferFixed(obj: io.flow.common.v0.models.DiscountOfferFixed): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "discount_offer_fixed")
    }

    implicit def jsonWritesCommonDiscountOfferFixed: play.api.libs.json.Writes[DiscountOfferFixed] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.DiscountOfferFixed] {
        def writes(obj: io.flow.common.v0.models.DiscountOfferFixed) = {
          jsObjectDiscountOfferFixed(obj)
        }
      }
    }
    ...
    def jsObjectDiscountOfferPercent(obj: io.flow.common.v0.models.DiscountOfferPercent): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "discount_offer_percent")
    }

    implicit def jsonWritesCommonDiscountOfferPercent: play.api.libs.json.Writes[DiscountOfferPercent] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.DiscountOfferPercent] {
        def writes(obj: io.flow.common.v0.models.DiscountOfferPercent) = {
          jsObjectDiscountOfferPercent(obj)
        }
      }
    }
    ...
    def jsObjectInputSpecificationLimitationMax(obj: io.flow.common.v0.models.InputSpecificationLimitationMax): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "input_specification_limitation_max")
    }

    implicit def jsonWritesCommonInputSpecificationLimitationMax: play.api.libs.json.Writes[InputSpecificationLimitationMax] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.InputSpecificationLimitationMax] {
        def writes(obj: io.flow.common.v0.models.InputSpecificationLimitationMax) = {
          jsObjectInputSpecificationLimitationMax(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonLineItemAttributesForm: play.api.libs.json.Reads[LineItemAttributesForm] = {
      (__ \ "attributes").read[Map[String, String]].map { x => new LineItemAttributesForm(attributes = x) }
    }

    def jsObjectLineItemAttributesForm(obj: io.flow.common.v0.models.LineItemAttributesForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "attributes" -> play.api.libs.json.Json.toJson(obj.attributes)
      )
    }

    implicit def jsonWritesCommonLineItemAttributesForm: play.api.libs.json.Writes[LineItemAttributesForm] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.LineItemAttributesForm] {
        def writes(obj: io.flow.common.v0.models.LineItemAttributesForm) = {
          jsObjectLineItemAttributesForm(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonLineItemQuantityForm: play.api.libs.json.Reads[LineItemQuantityForm] = {
      (__ \ "quantity").read[Long].map { x => new LineItemQuantityForm(quantity = x) }
    }

    def jsObjectLineItemQuantityForm(obj: io.flow.common.v0.models.LineItemQuantityForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "quantity" -> play.api.libs.json.JsNumber(obj.quantity)
      )
    }

    implicit def jsonWritesCommonLineItemQuantityForm: play.api.libs.json.Writes[LineItemQuantityForm] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.LineItemQuantityForm] {
        def writes(obj: io.flow.common.v0.models.LineItemQuantityForm) = {
          jsObjectLineItemQuantityForm(obj)
        }
      }
    }
    ...
    def jsObjectOrganization(obj: io.flow.common.v0.models.Organization): play.api.libs.json.JsObject = {
      ...
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "organization")
    }
    ...
    def jsObjectOrganizationReference(obj: io.flow.common.v0.models.OrganizationReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "organization_reference")
    }

    implicit def jsonWritesCommonOrganizationReference: play.api.libs.json.Writes[OrganizationReference] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.OrganizationReference] {
        def writes(obj: io.flow.common.v0.models.OrganizationReference) = {
          jsObjectOrganizationReference(obj)
        }
      }
    }
    ...
    def jsObjectPriceSourceCatalog(obj: io.flow.common.v0.models.PriceSourceCatalog): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "price" -> jsObjectMoney(obj.price)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "catalog")
    }

    implicit def jsonWritesCommonPriceSourceCatalog: play.api.libs.json.Writes[PriceSourceCatalog] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.PriceSourceCatalog] {
        def writes(obj: io.flow.common.v0.models.PriceSourceCatalog) = {
          jsObjectPriceSourceCatalog(obj)
        }
      }
    }
    ...
    def jsObjectPriceSourcePriceBook(obj: io.flow.common.v0.models.PriceSourcePriceBook): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "price_book")
    }

    implicit def jsonWritesCommonPriceSourcePriceBook: play.api.libs.json.Writes[PriceSourcePriceBook] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.PriceSourcePriceBook] {
        def writes(obj: io.flow.common.v0.models.PriceSourcePriceBook) = {
          jsObjectPriceSourcePriceBook(obj)
        }
      }
    }
    ...
    def jsObjectPriceSourceProvided(obj: io.flow.common.v0.models.PriceSourceProvided): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "price" -> jsObjectMoney(obj.price)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "provided")
    }

    implicit def jsonWritesCommonPriceSourceProvided: play.api.libs.json.Writes[PriceSourceProvided] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.PriceSourceProvided] {
        def writes(obj: io.flow.common.v0.models.PriceSourceProvided) = {
          jsObjectPriceSourceProvided(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonRepeatDaily: play.api.libs.json.Reads[RepeatDaily] = {
      (__ \ "interval").read[Int].map { x => new RepeatDaily(interval = x) }
    }

    def jsObjectRepeatDaily(obj: io.flow.common.v0.models.RepeatDaily): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "interval" -> play.api.libs.json.JsNumber(obj.interval)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_daily")
    }

    implicit def jsonWritesCommonRepeatDaily: play.api.libs.json.Writes[RepeatDaily] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.RepeatDaily] {
        def writes(obj: io.flow.common.v0.models.RepeatDaily) = {
          jsObjectRepeatDaily(obj)
        }
      }
    }

    implicit def jsonReadsCommonRepeatHourly: play.api.libs.json.Reads[RepeatHourly] = {
      (__ \ "interval").read[Int].map { x => new RepeatHourly(interval = x) }
    }

    def jsObjectRepeatHourly(obj: io.flow.common.v0.models.RepeatHourly): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "interval" -> play.api.libs.json.JsNumber(obj.interval)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_hourly")
    }

    implicit def jsonWritesCommonRepeatHourly: play.api.libs.json.Writes[RepeatHourly] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.RepeatHourly] {
        def writes(obj: io.flow.common.v0.models.RepeatHourly) = {
          jsObjectRepeatHourly(obj)
        }
      }
    }

    implicit def jsonReadsCommonRepeatMonthly: play.api.libs.json.Reads[RepeatMonthly] = {
      for {
        interval <- (__ \ "interval").read[Int]
        days <- (__ \ "days").read[Seq[Int]]
      } yield RepeatMonthly(interval, days)
    }

    def jsObjectRepeatMonthly(obj: io.flow.common.v0.models.RepeatMonthly): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "interval" -> play.api.libs.json.JsNumber(obj.interval),
        "days" -> play.api.libs.json.Json.toJson(obj.days)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_monthly")
    }

    implicit def jsonWritesCommonRepeatMonthly: play.api.libs.json.Writes[RepeatMonthly] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.RepeatMonthly] {
        def writes(obj: io.flow.common.v0.models.RepeatMonthly) = {
          jsObjectRepeatMonthly(obj)
        }
      }
    }

    implicit def jsonReadsCommonRepeatWeekly: play.api.libs.json.Reads[RepeatWeekly] = {
      for {
        interval <- (__ \ "interval").read[Int]
        daysOfWeek <- (__ \ "days_of_week").read[Seq[io.flow.common.v0.models.DayOfWeek]]
      } yield RepeatWeekly(interval, daysOfWeek)
    }

    def jsObjectRepeatWeekly(obj: io.flow.common.v0.models.RepeatWeekly): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "interval" -> play.api.libs.json.JsNumber(obj.interval),
        "days_of_week" -> play.api.libs.json.Json.toJson(obj.daysOfWeek)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_weekly")
    }

    implicit def jsonWritesCommonRepeatWeekly: play.api.libs.json.Writes[RepeatWeekly] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.RepeatWeekly] {
        def writes(obj: io.flow.common.v0.models.RepeatWeekly) = {
          jsObjectRepeatWeekly(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonSessionReference: play.api.libs.json.Reads[SessionReference] = {
      (__ \ "id").read[String].map { x => new SessionReference(id = x) }
    }

    def jsObjectSessionReference(obj: io.flow.common.v0.models.SessionReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesCommonSessionReference: play.api.libs.json.Writes[SessionReference] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.SessionReference] {
        def writes(obj: io.flow.common.v0.models.SessionReference) = {
          jsObjectSessionReference(obj)
        }
      }
    }
    ...
    def jsObjectUserReference(obj: io.flow.common.v0.models.UserReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "user_reference")
    }

    implicit def jsonWritesCommonUserReference: play.api.libs.json.Writes[UserReference] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.UserReference] {
        def writes(obj: io.flow.common.v0.models.UserReference) = {
          jsObjectUserReference(obj)
        }
      }
    }
    ...
    def jsObjectDiscountOffer(obj: io.flow.common.v0.models.DiscountOffer): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.DiscountOfferFixed => jsObjectDiscountOfferFixed(x)
        case x: io.flow.common.v0.models.DiscountOfferPercent => jsObjectDiscountOfferPercent(x)
        case other => {
    ...
    def jsObjectExpandableOrganization(obj: io.flow.common.v0.models.ExpandableOrganization): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.Organization => jsObjectOrganization(x)
        case x: io.flow.common.v0.models.OrganizationReference => jsObjectOrganizationReference(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    def jsObjectExpandableUser(obj: io.flow.common.v0.models.ExpandableUser): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.User => jsObjectUser(x)
        case x: io.flow.common.v0.models.UserReference => jsObjectUserReference(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    def jsObjectInputSpecificationLimitation(obj: io.flow.common.v0.models.InputSpecificationLimitation): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.InputSpecificationLimitationMax => jsObjectInputSpecificationLimitationMax(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    def jsObjectPriceSource(obj: io.flow.common.v0.models.PriceSource): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.PriceSourcePriceBook => jsObjectPriceSourcePriceBook(x)
        case x: io.flow.common.v0.models.PriceSourceCatalog => jsObjectPriceSourceCatalog(x)
        case x: io.flow.common.v0.models.PriceSourceProvided => jsObjectPriceSourceProvided(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonReadsCommonRepeatSchedule: play.api.libs.json.Reads[RepeatSchedule] = new play.api.libs.json.Reads[RepeatSchedule] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[RepeatSchedule] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[RepeatSchedule] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
          case "repeat_hourly" => js.validate[io.flow.common.v0.models.RepeatHourly]
          case "repeat_daily" => js.validate[io.flow.common.v0.models.RepeatDaily]
          case "repeat_weekly" => js.validate[io.flow.common.v0.models.RepeatWeekly]
          case "repeat_monthly" => js.validate[io.flow.common.v0.models.RepeatMonthly]
          case other => play.api.libs.json.JsSuccess(io.flow.common.v0.models.RepeatScheduleUndefinedType(other))
        }
      }
    }

    def jsObjectRepeatSchedule(obj: io.flow.common.v0.models.RepeatSchedule): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.RepeatHourly => jsObjectRepeatHourly(x)
        case x: io.flow.common.v0.models.RepeatDaily => jsObjectRepeatDaily(x)
        case x: io.flow.common.v0.models.RepeatWeekly => jsObjectRepeatWeekly(x)
        case x: io.flow.common.v0.models.RepeatMonthly => jsObjectRepeatMonthly(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonRepeatSchedule: play.api.libs.json.Writes[RepeatSchedule] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.RepeatSchedule] {
        def writes(obj: io.flow.common.v0.models.RepeatSchedule) = {
          jsObjectRepeatSchedule(obj)
        }
      }
    }
  }
...
package io.flow.common.v0 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      val goodsSupplyConverter: ApibuilderTypeConverter[io.flow.common.v0.models.GoodsSupply] = new ApibuilderTypeConverter[io.flow.common.v0.models.GoodsSupply] {
        override def convert(value: String): io.flow.common.v0.models.GoodsSupply = io.flow.common.v0.models.GoodsSupply(value)
        override def convert(value: io.flow.common.v0.models.GoodsSupply): String = value.toString
        override def example: io.flow.common.v0.models.GoodsSupply = io.flow.common.v0.models.GoodsSupply.Export
        override def validValues: Seq[io.flow.common.v0.models.GoodsSupply] = io.flow.common.v0.models.GoodsSupply.all
      }
      implicit def pathBindableGoodsSupply(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.common.v0.models.GoodsSupply] = ApibuilderPathBindable(goodsSupplyConverter)
      implicit def queryStringBindableGoodsSupply(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.common.v0.models.GoodsSupply] = ApibuilderQueryStringBindable(goodsSupplyConverter)
