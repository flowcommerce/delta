 ...
 * apibuilder 0.14.89 app.apibuilder.io/flow/common/latest/play_2_x_json
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    def jsObjectRepeatSchedule(obj: io.flow.common.v0.models.RepeatSchedule): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.RepeatHourly => jsObjectRepeatHourly(x) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_hourly")
        case x: io.flow.common.v0.models.RepeatDaily => jsObjectRepeatDaily(x) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_daily")
        case x: io.flow.common.v0.models.RepeatWeekly => jsObjectRepeatWeekly(x) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_weekly")
        case x: io.flow.common.v0.models.RepeatMonthly => jsObjectRepeatMonthly(x) ++ play.api.libs.json.Json.obj("discriminator" -> "repeat_monthly")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
