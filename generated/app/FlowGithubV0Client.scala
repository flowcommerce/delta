 ...
 * Service version: 0.2.40
 * apibuilder 0.15.11 app.apibuilder.io/flow/github/latest/play_2_8_client
 */
...
package io.flow.github.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsGithubUserOrg: play.api.libs.json.Reads[UserOrg] = {
      (__ \ "login").read[String].map { x => new UserOrg(login = x) }
    }
    ...
    implicit def jsonWritesGithubUserOrg: play.api.libs.json.Writes[UserOrg] = {
      new play.api.libs.json.Writes[io.flow.github.v0.models.UserOrg] {
        def writes(obj: io.flow.github.v0.models.UserOrg) = {
          jsObjectUserOrg(obj)
        }
      }
    }
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.11 app.apibuilder.io/flow/github/latest/play_2_8_client"
    val Version = "0.2.40"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Blobs extends Blobs {
      override def getBySha(
      ...
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Blob]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/blobs/${play.utils.UriEncoding.encodePathSegment(sha, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Blob", r, _.validate[io.flow.github.v0.models.Blob])
      ...
      override def post(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.BlobCreated]] = {
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/blobs", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.BlobCreated", r, _.validate[io.flow.github.v0.models.BlobCreated])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
    ...
    object Commits extends Commits {
      override def getBySha(
        ...
        sha: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Commit]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/commits/${play.utils.UriEncoding.encodePathSegment(sha, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Commit", r, _.validate[io.flow.github.v0.models.Commit])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
      ...
      override def post(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.CommitResponse]] = {
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/commits", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.CommitResponse", r, _.validate[io.flow.github.v0.models.CommitResponse])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
    ...
    object Contents extends Contents {
      override def getReadme(
        ...
        ref: String = "master",
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Contents]] = {
        ...
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/readme", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Contents", r, _.validate[io.flow.github.v0.models.Contents])
    ...
    object Hooks extends Hooks {
      override def get(
        ...
        repo: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.Hook]]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/hooks", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.Hook]", r, _.validate[Seq[io.flow.github.v0.models.Hook]])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def getById(
        ...
        id: Long,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Hook]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/hooks/${id}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Hook", r, _.validate[io.flow.github.v0.models.Hook])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/hooks", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Hook", r, _.validate[io.flow.github.v0.models.Hook])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
    ...
    object PullRequests extends PullRequests {
      override def post(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.PullRequest]] = {
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/pulls", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.PullRequest", r, _.validate[io.flow.github.v0.models.PullRequest])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
      ...
      override def get(
        ...
        page: Long = 1L,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.PullRequest]]] = {
        val queryParameters = Seq(
        ...
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/pulls", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.PullRequest]", r, _.validate[Seq[io.flow.github.v0.models.PullRequest]])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object Refs extends Refs {
      override def get(
        ...
        repo: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.Ref]]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/refs", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.Ref]", r, _.validate[Seq[io.flow.github.v0.models.Ref]])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def getByRef(
        ...
        ref: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Ref]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/refs/${play.utils.UriEncoding.encodePathSegment(ref, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Ref", r, _.validate[io.flow.github.v0.models.Ref])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/refs", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Ref", r, _.validate[io.flow.github.v0.models.Ref])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
    ...
    object Repositories extends Repositories {
      override def getUserAndRepos(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.Repository]]] = {
        val queryParameters = Seq(
          Some("page" -> page.toString),
        ...
        _executeRequest("GET", s"/user/repos", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.Repository]", r, _.validate[Seq[io.flow.github.v0.models.Repository]])
          case r if r.status == 401 => throw io.flow.github.v0.errors.UnitResponse(r.status)
    ...
    object Tags extends Tags {
      override def getTags(
        ...
        perPage: Long = 30L,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.TagSummary]]] = {
        val queryParameters = Seq(
          Some("page" -> page.toString),
        ...
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/tags", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.TagSummary]", r, _.validate[Seq[io.flow.github.v0.models.TagSummary]])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def getTagsBySha(
        ...
        sha: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.Tag]] = {
        _executeRequest("GET", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/tags/${play.utils.UriEncoding.encodePathSegment(sha, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Tag", r, _.validate[io.flow.github.v0.models.Tag])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def postGitAndTags(
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/tags", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.Tag", r, _.validate[io.flow.github.v0.models.Tag])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
    ...
    object Trees extends Trees {
      override def post(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.CreateTreeResponse]] = {
        ...
        _executeRequest("POST", s"/repos/${play.utils.UriEncoding.encodePathSegment(owner, "UTF-8")}/${play.utils.UriEncoding.encodePathSegment(repo, "UTF-8")}/git/trees", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.CreateTreeResponse", r, _.validate[io.flow.github.v0.models.CreateTreeResponse])
          case r if r.status == 404 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.github.v0.errors.UnprocessableEntityResponse(r)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 404, 422")
        }
    ...
    object UserEmails extends UserEmails {
      override def get(
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.UserEmail]]] = {
        _executeRequest("GET", s"/user/emails", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.UserEmail]", r, _.validate[Seq[io.flow.github.v0.models.UserEmail]])
          case r if r.status == 401 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
    ...
    object Users extends Users {
      override def getUser(
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[io.flow.github.v0.models.User]] = {
        _executeRequest("GET", s"/user", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("io.flow.github.v0.models.User", r, _.validate[io.flow.github.v0.models.User])
          case r if r.status == 401 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
      ...
      override def getUserAndOrgs(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.v0.Response[Seq[io.flow.github.v0.models.UserOrg]]] = {
        val queryParameters = Seq(
          Some("page" -> page.toString),
        ...
        _executeRequest("GET", s"/user/orgs", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.github.v0.Client.buildResponse("Seq[io.flow.github.v0.models.UserOrg]", r, _.validate[Seq[io.flow.github.v0.models.UserOrg]])
          case r if r.status == 401 => throw io.flow.github.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.github.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
