 ...
 * apidoc:0.11.38 http://www.apidoc.me/flow/common/0.0.60/play_2_4_client
 */
package io.flow.common.v0.models {
   ...
   * management (verification of who the person id), and reporting. We also recommend
   * including your customer.number whenever possible as doing so will allow Flow to
   * link up transactions for this customer making customer service easieer.
   */
  case class Customer(
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    def jsObjectDimensions(obj: io.flow.common.v0.models.Dimensions) = {
      (obj.product match {
        case None => play.api.libs.json.Json.obj()
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.38 http://www.apidoc.me/flow/common/0.0.60/play_2_4_client"
    val Version = "0.0.60"
    val VersionMajor = 0
