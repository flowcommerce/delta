 ...
 * Service version: 0.3.89-dev
 * apidoc:0.11.80 http://www.apidoc.me/flow/delta-config/0.3.89-dev/play_2_x_json
 */
package io.flow.delta.config.v0.models {
   ...
   */
  sealed trait ConfigDiscriminator
  ...
  object ConfigDiscriminator {
    ...
    val all = Seq(ConfigProject, ConfigError)
  ...
  object BuildStage {
     ...
     * above.
     */
    val all = Seq(SetDesiredState, SyncDockerImage, BuildDockerImage, Scale)
  ...
  object InstanceType {
     ...
     * above.
     */
    val all = Seq(C4Large, M4Large, T2Micro, T2Small, T2Medium, T2Large)
