 ...
 * Service version: 0.6.88
 * apibuilder 0.14.59 app.apibuilder.io/flow/delta-config/0.6.88/play_2_x_json
 */
package io.flow.delta.config.v0.delta.config.v0.models {
  ...
  final case class Build(
    ...
    instanceType: io.flow.delta.config.v0.delta.config.v0.models.InstanceType,
    memory: _root_.scala.Option[Long] = None,
    portContainer: Int,
    portHost: Int,
    remoteLogging: _root_.scala.Option[Boolean] = None,
    stages: Seq[io.flow.delta.config.v0.delta.config.v0.models.BuildStage],
  ...
  final case class ConfigProject(
    stages: Seq[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage],
    builds: Seq[io.flow.delta.config.v0.delta.config.v0.models.Build],
    branches: Seq[io.flow.delta.config.v0.delta.config.v0.models.Branch]
  ) extends Config
  ...
  object InstanceType {
     ...
     * above.
     */
    val all: scala.List[InstanceType] = scala.List(C4Large, C4Xlarge, C42xlarge, M4Large, M4Xlarge, M42xlarge, M5Large, M5Xlarge, M52xlarge, C5Large, C5Xlarge, C52xlarge, T2Micro, T2Small, T2Medium, T2Large, T3Micro, T3Small, T3Medium, T3Large, T3Xlarge)
...
package io.flow.delta.config.v0.delta.config.v0.models {
  ...
  package object json {
    ...
    import io.flow.delta.config.v0.delta.config.v0.models.json._
    ...
    implicit val jsonReadsDeltaConfigBuildStage = new play.api.libs.json.Reads[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.BuildStage(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.BuildStage(v))
    ...
    def jsonWritesDeltaConfigBuildStage(obj: io.flow.delta.config.v0.delta.config.v0.models.BuildStage) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectBuildStage(obj: io.flow.delta.config.v0.delta.config.v0.models.BuildStage) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesDeltaConfigBuildStage: play.api.libs.json.Writes[BuildStage] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.BuildStage) = {
          jsonWritesDeltaConfigBuildStage(obj)
        }
      }
    }

    implicit val jsonReadsDeltaConfigInstanceType = new play.api.libs.json.Reads[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.InstanceType(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.InstanceType(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesDeltaConfigInstanceType(obj: io.flow.delta.config.v0.delta.config.v0.models.InstanceType) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectInstanceType(obj: io.flow.delta.config.v0.delta.config.v0.models.InstanceType) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesDeltaConfigInstanceType: play.api.libs.json.Writes[InstanceType] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.InstanceType) = {
          jsonWritesDeltaConfigInstanceType(obj)
        }
      }
    }

    implicit val jsonReadsDeltaConfigProjectStage = new play.api.libs.json.Reads[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.ProjectStage(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.ProjectStage(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesDeltaConfigProjectStage(obj: io.flow.delta.config.v0.delta.config.v0.models.ProjectStage) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectProjectStage(obj: io.flow.delta.config.v0.delta.config.v0.models.ProjectStage) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesDeltaConfigProjectStage: play.api.libs.json.Writes[ProjectStage] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.ProjectStage) = {
    ...
    def jsObjectBranch(obj: io.flow.delta.config.v0.delta.config.v0.models.Branch): play.api.libs.json.JsObject = {
    ...
    implicit def jsonWritesDeltaConfigBranch: play.api.libs.json.Writes[Branch] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.Branch] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.Branch) = {
          jsObjectBranch(obj)
        }
      }
    }
    ...
    implicit def jsonReadsDeltaConfigBuild: play.api.libs.json.Reads[Build] = {
      for {
        ...
        instanceType <- (__ \ "instance_type").read[io.flow.delta.config.v0.delta.config.v0.models.InstanceType]
        ...
        stages <- (__ \ "stages").read[Seq[io.flow.delta.config.v0.delta.config.v0.models.BuildStage]]
    ...
    def jsObjectBuild(obj: io.flow.delta.config.v0.delta.config.v0.models.Build): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "name" -> play.api.libs.json.JsString(obj.name),
    ...
    implicit def jsonWritesDeltaConfigBuild: play.api.libs.json.Writes[Build] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.Build] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.Build) = {
          jsObjectBuild(obj)
        }
      }
    }
    ...
    def jsObjectConfigError(obj: io.flow.delta.config.v0.delta.config.v0.models.ConfigError): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsDeltaConfigConfigProject: play.api.libs.json.Reads[ConfigProject] = {
      for {
        stages <- (__ \ "stages").read[Seq[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage]]
        builds <- (__ \ "builds").read[Seq[io.flow.delta.config.v0.delta.config.v0.models.Build]]
        branches <- (__ \ "branches").read[Seq[io.flow.delta.config.v0.delta.config.v0.models.Branch]]
      } yield ConfigProject(stages, builds, branches)
    }

    def jsObjectConfigProject(obj: io.flow.delta.config.v0.delta.config.v0.models.ConfigProject): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "stages" -> play.api.libs.json.Json.toJson(obj.stages),
    ...
    implicit def jsonReadsDeltaConfigConfig: play.api.libs.json.Reads[Config] = new play.api.libs.json.Reads[Config] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Config] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[Config] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
          case "config_project" => js.validate[io.flow.delta.config.v0.delta.config.v0.models.ConfigProject]
          case "config_error" => js.validate[io.flow.delta.config.v0.delta.config.v0.models.ConfigError]
          case other => play.api.libs.json.JsSuccess(io.flow.delta.config.v0.delta.config.v0.models.ConfigUndefinedType(other))
        }
      }
    }

    def jsObjectConfig(obj: io.flow.delta.config.v0.delta.config.v0.models.Config): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.delta.config.v0.delta.config.v0.models.ConfigProject => jsObjectConfigProject(x) ++ play.api.libs.json.Json.obj("discriminator" -> "config_project")
        case x: io.flow.delta.config.v0.delta.config.v0.models.ConfigError => jsObjectConfigError(x) ++ play.api.libs.json.Json.obj("discriminator" -> "config_error")
        case other => {
    ...
    implicit def jsonWritesDeltaConfigConfig: play.api.libs.json.Writes[Config] = {
      new play.api.libs.json.Writes[io.flow.delta.config.v0.delta.config.v0.models.Config] {
        def writes(obj: io.flow.delta.config.v0.delta.config.v0.models.Config) = {
          jsObjectConfig(obj)
        }
      }
    }
...
package io.flow.delta.config.v0.delta.config.v0 {
  ...
  object Bindables {
    ...
    object Models {
      import io.flow.delta.config.v0.delta.config.v0.models._

      val buildStageConverter: ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] = new ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] {
        override def convert(value: String): io.flow.delta.config.v0.delta.config.v0.models.BuildStage = io.flow.delta.config.v0.delta.config.v0.models.BuildStage(value)
        override def convert(value: io.flow.delta.config.v0.delta.config.v0.models.BuildStage): String = value.toString
        override def example: io.flow.delta.config.v0.delta.config.v0.models.BuildStage = io.flow.delta.config.v0.delta.config.v0.models.BuildStage.SetDesiredState
        override def validValues: Seq[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] = io.flow.delta.config.v0.delta.config.v0.models.BuildStage.all
      }
      implicit def pathBindableBuildStage(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] = ApibuilderPathBindable(buildStageConverter)
      implicit def queryStringBindableBuildStage(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.delta.config.v0.delta.config.v0.models.BuildStage] = ApibuilderQueryStringBindable(buildStageConverter)

      val instanceTypeConverter: ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] = new ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] {
        override def convert(value: String): io.flow.delta.config.v0.delta.config.v0.models.InstanceType = io.flow.delta.config.v0.delta.config.v0.models.InstanceType(value)
        override def convert(value: io.flow.delta.config.v0.delta.config.v0.models.InstanceType): String = value.toString
        override def example: io.flow.delta.config.v0.delta.config.v0.models.InstanceType = io.flow.delta.config.v0.delta.config.v0.models.InstanceType.C4Large
        override def validValues: Seq[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] = io.flow.delta.config.v0.delta.config.v0.models.InstanceType.all
      }
      implicit def pathBindableInstanceType(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] = ApibuilderPathBindable(instanceTypeConverter)
      implicit def queryStringBindableInstanceType(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.delta.config.v0.delta.config.v0.models.InstanceType] = ApibuilderQueryStringBindable(instanceTypeConverter)

      val projectStageConverter: ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] = new ApibuilderTypeConverter[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] {
        override def convert(value: String): io.flow.delta.config.v0.delta.config.v0.models.ProjectStage = io.flow.delta.config.v0.delta.config.v0.models.ProjectStage(value)
        override def convert(value: io.flow.delta.config.v0.delta.config.v0.models.ProjectStage): String = value.toString
        override def example: io.flow.delta.config.v0.delta.config.v0.models.ProjectStage = io.flow.delta.config.v0.delta.config.v0.models.ProjectStage.SyncShas
        override def validValues: Seq[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] = io.flow.delta.config.v0.delta.config.v0.models.ProjectStage.all
      }
      implicit def pathBindableProjectStage(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] = ApibuilderPathBindable(projectStageConverter)
      implicit def queryStringBindableProjectStage(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.delta.config.v0.delta.config.v0.models.ProjectStage] = ApibuilderQueryStringBindable(projectStageConverter)
    }
