 ...
 * apibuilder 0.14.96 app.apibuilder.io/flow/delta/latest/play_2_8_client
 */
...
package io.flow.delta.v0.models {
  ...
  package object json {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "docker_provider").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.delta.v0.models.DockerProvider(v))
    ...
    implicit def jsonReadsDeltaDashboardBuild: play.api.libs.json.Reads[DashboardBuild] = {
      ...
      } yield DashboardBuild(id, project, name, cluster, desired, last)
    }
    ...
    implicit def jsonWritesDeltaProjectSummary: play.api.libs.json.Writes[ProjectSummary] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.ProjectSummary] {
        def writes(obj: io.flow.delta.v0.models.ProjectSummary) = {
    ...
    implicit def jsonReadsDeltaSnsMessageAmi: play.api.libs.json.Reads[SnsMessageAmi] = {
      (__ \ "ECSAmis").read[Seq[io.flow.delta.v0.models.EcsAmis]].map { x => new SnsMessageAmi(ECSAmis = x) }
    }
    ...
    def jsObjectItemSummary(obj: io.flow.delta.v0.models.ItemSummary): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.delta.v0.models.ProjectSummary => jsObjectProjectSummary(x)
        case other => {
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.96 app.apibuilder.io/flow/delta/latest/play_2_8_client"
    val Version = "0.8.36"
    val VersionMajor = 0
    ...
    object DashboardBuilds extends DashboardBuilds {
      override def get(
        ...
        val queryParameters = Seq(
          ...
          cluster.map("cluster" -> _.toString),
