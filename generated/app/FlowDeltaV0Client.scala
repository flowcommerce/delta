 ...
 * Service version: 0.3.92-dev
 * apidoc:0.11.84 http://www.apidoc.me/flow/delta/0.3.92-dev/play_2_4_client
 */
package io.flow.delta.v0.models {
   ...
   */
  sealed trait ItemSummaryDiscriminator
  ...
  case class Version(
    name: String,
    instances: Long,
    serviceName: _root_.scala.Option[String] = None
  )
...
package io.flow.delta.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaVersion: play.api.libs.json.Reads[Version] = {
      (
        (__ \ "name").read[String] and
        (__ \ "instances").read[Long] and
        (__ \ "service_name").readNullable[String]
      )(Version.apply _)
    }
    ...
    def jsObjectVersion(obj: io.flow.delta.v0.models.Version) = {
      ...
      ) ++ (obj.serviceName match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("service_name" -> play.api.libs.json.JsString(x))
      })
    }
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.84 http://www.apidoc.me/flow/delta/0.3.92-dev/play_2_4_client"
    val Version = "0.3.92-dev"
    val VersionMajor = 0
