 ...
 * Service version: 0.5.61-44-ge80aacf
 * apibuilder 0.14.3 app.apibuilder.io/flow/delta/0.5.61-44-ge80aacf/play_2_6_client
 */
package io.flow.delta.v0.models {
  ...
  sealed trait SnsMessageAmi extends _root_.scala.Product with _root_.scala.Serializable

  /**
   * Defines the valid Type values for the type SnsMessageAmi
   */
  sealed trait SnsMessageAmiType extends _root_.scala.Product with _root_.scala.Serializable

  object SnsMessageAmiType {

    /**
     * See
     * https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ECS-AMI-SubscribeTopic.html#ECS-AMI-Notification-format
     */
    case object SubscriptionConfirmation extends SnsMessageAmiType { override def toString = "SubscriptionConfirmation" }
    case object Notification extends SnsMessageAmiType { override def toString = "Notification" }

    case class UNDEFINED(override val toString: String) extends SnsMessageAmiType

    val all: scala.List[SnsMessageAmiType] = scala.List(SubscriptionConfirmation, Notification)

    private[this] val byName: Map[String, SnsMessageAmiType] = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): SnsMessageAmiType = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[SnsMessageAmiType] = byName.get(value.toLowerCase)

  }

  case class Notification(
    Message: io.flow.delta.v0.models.SnsMessageAmiUpdate
  ) extends SnsMessageAmi

  case class SubscriptionConfirmation(
    SubscribeURL: String
  ) extends SnsMessageAmi
  ...
  case class SnsMessageAmiUpdate(
    ECSAmis: io.flow.delta.v0.models.EcsAmis
  )
  ...
  /**
   * Provides future compatibility in clients - in the future, when a type is added
   * to the union SnsMessageAmi, it will need to be handled in the client code. This
   * implementation will deserialize these future types as an instance of this class.
   * 
   * @param description Information about the type that we received that is undefined in this version of
   *        the client.
   */
  case class SnsMessageAmiUndefinedType(
    description: String
  ) extends SnsMessageAmi
...
package io.flow.delta.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaNotification: play.api.libs.json.Reads[Notification] = {
      (__ \ "Message").read[io.flow.delta.v0.models.SnsMessageAmiUpdate].map { x => new Notification(Message = x) }
    }

    def jsObjectNotification(obj: io.flow.delta.v0.models.Notification): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "Message" -> jsObjectSnsMessageAmiUpdate(obj.Message)
      )
    }

    implicit def jsonReadsDeltaSubscriptionConfirmation: play.api.libs.json.Reads[SubscriptionConfirmation] = {
      (__ \ "SubscribeURL").read[String].map { x => new SubscriptionConfirmation(SubscribeURL = x) }
    }

    def jsObjectSubscriptionConfirmation(obj: io.flow.delta.v0.models.SubscriptionConfirmation): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "SubscribeURL" -> play.api.libs.json.JsString(obj.SubscribeURL)
      )
    }
    ...
    implicit def jsonWritesDeltaEcsAmiRegionImage: play.api.libs.json.Writes[EcsAmiRegionImage] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.EcsAmiRegionImage] {
        def writes(obj: io.flow.delta.v0.models.EcsAmiRegionImage) = {
    ...
    implicit def jsonReadsDeltaEcsAmiRegions: play.api.libs.json.Reads[EcsAmiRegions] = {
      (__ \ "us-east-1").read[io.flow.delta.v0.models.EcsAmiRegionImage].map { x => new EcsAmiRegions(usEast1 = x) }
    }

    def jsObjectEcsAmiRegions(obj: io.flow.delta.v0.models.EcsAmiRegions): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesDeltaEcsAmiRegions: play.api.libs.json.Writes[EcsAmiRegions] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.EcsAmiRegions] {
        def writes(obj: io.flow.delta.v0.models.EcsAmiRegions) = {
    ...
    implicit def jsonReadsDeltaEcsAmis: play.api.libs.json.Reads[EcsAmis] = {
      (__ \ "Regions").read[io.flow.delta.v0.models.EcsAmiRegions].map { x => new EcsAmis(Regions = x) }
    }

    def jsObjectEcsAmis(obj: io.flow.delta.v0.models.EcsAmis): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesDeltaEcsAmis: play.api.libs.json.Writes[EcsAmis] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.EcsAmis] {
        def writes(obj: io.flow.delta.v0.models.EcsAmis) = {
          jsObjectEcsAmis(obj)
        }
      }
    }
    ...
    implicit def jsonReadsDeltaSnsMessageAmiUpdate: play.api.libs.json.Reads[SnsMessageAmiUpdate] = {
      (__ \ "ECSAmis").read[io.flow.delta.v0.models.EcsAmis].map { x => new SnsMessageAmiUpdate(ECSAmis = x) }
    }

    def jsObjectSnsMessageAmiUpdate(obj: io.flow.delta.v0.models.SnsMessageAmiUpdate): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "ECSAmis" -> jsObjectEcsAmis(obj.ECSAmis)
      )
    }

    implicit def jsonWritesDeltaSnsMessageAmiUpdate: play.api.libs.json.Writes[SnsMessageAmiUpdate] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.SnsMessageAmiUpdate] {
        def writes(obj: io.flow.delta.v0.models.SnsMessageAmiUpdate) = {
          jsObjectSnsMessageAmiUpdate(obj)
        }
      }
    }
    ...
    implicit def jsonReadsDeltaSnsMessageAmi: play.api.libs.json.Reads[SnsMessageAmi] = new play.api.libs.json.Reads[SnsMessageAmi] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[SnsMessageAmi] = {
        (js \ "Type").asOpt[String].getOrElse { sys.error("Union[SnsMessageAmi] requires a discriminator named 'Type' - this field was not found in the Json Value") } match {
          case "SubscriptionConfirmation" => js.validate[io.flow.delta.v0.models.SubscriptionConfirmation]
          case "Notification" => js.validate[io.flow.delta.v0.models.Notification]
          case other => play.api.libs.json.JsSuccess(io.flow.delta.v0.models.SnsMessageAmiUndefinedType(other))
        }
      }
    }

    def jsObjectSnsMessageAmi(obj: io.flow.delta.v0.models.SnsMessageAmi): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.delta.v0.models.SubscriptionConfirmation => jsObjectSubscriptionConfirmation(x) ++ play.api.libs.json.Json.obj("Type" -> "SubscriptionConfirmation")
        case x: io.flow.delta.v0.models.Notification => jsObjectNotification(x) ++ play.api.libs.json.Json.obj("Type" -> "Notification")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesDeltaSnsMessageAmi: play.api.libs.json.Writes[SnsMessageAmi] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.SnsMessageAmi] {
        def writes(obj: io.flow.delta.v0.models.SnsMessageAmi) = {
...
package io.flow.delta.v0 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      val dockerProviderConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.DockerProvider] = new ApibuilderTypeConverter[io.flow.delta.v0.models.DockerProvider] {
        override def convert(value: String): io.flow.delta.v0.models.DockerProvider = io.flow.delta.v0.models.DockerProvider(value)
        override def convert(value: io.flow.delta.v0.models.DockerProvider): String = value.toString
      ...
      val eventTypeConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.EventType] = new ApibuilderTypeConverter[io.flow.delta.v0.models.EventType] {
        ...
        override def convert(value: io.flow.delta.v0.models.EventType): String = value.toString
      ...
      val publicationConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.Publication] = new ApibuilderTypeConverter[io.flow.delta.v0.models.Publication] {
        ...
        override def convert(value: io.flow.delta.v0.models.Publication): String = value.toString
      ...
      val roleConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.Role] = new ApibuilderTypeConverter[io.flow.delta.v0.models.Role] {
        ...
        override def convert(value: io.flow.delta.v0.models.Role): String = value.toString
      ...
      val scmsConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.Scms] = new ApibuilderTypeConverter[io.flow.delta.v0.models.Scms] {
        ...
        override def convert(value: io.flow.delta.v0.models.Scms): String = value.toString
      ...
      val statusConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.Status] = new ApibuilderTypeConverter[io.flow.delta.v0.models.Status] {
        ...
        override def convert(value: io.flow.delta.v0.models.Status): String = value.toString
      ...
      val visibilityConverter: ApibuilderTypeConverter[io.flow.delta.v0.models.Visibility] = new ApibuilderTypeConverter[io.flow.delta.v0.models.Visibility] {
        ...
        override def convert(value: io.flow.delta.v0.models.Visibility): String = value.toString
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/delta/0.5.61-44-ge80aacf/play_2_6_client"
    val Version = "0.5.61-44-ge80aacf"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object GithubUsers extends GithubUsers {
      override def postGithub(
        ...
        _executeRequest("POST", s"/authentications/github", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw io.flow.delta.v0.errors.GenericErrorResponse(r)
    ...
    object SnsMessageAmis extends SnsMessageAmis {
      override def post(
        snsMessageAmi: io.flow.delta.v0.models.SnsMessageAmi,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit] = {
        val payload = play.api.libs.json.Json.toJson(snsMessageAmi)

        _executeRequest("POST", s"/sns_message_amis", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 200 => ()
          case r => throw io.flow.delta.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
    }
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def snsMessageAmis: io.flow.delta.v0.SnsMessageAmis
