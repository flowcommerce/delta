 ...
 * apidoc:0.11.38 http://www.apidoc.me/flow/delta/0.3.1/play_2_4_client
 */
...
package io.flow.delta.v0.models {
  ...
  package object json {
    ...
    def jsObjectAwsActor(obj: io.flow.delta.v0.models.AwsActor) = {
    ...
    def jsObjectBuild(obj: io.flow.delta.v0.models.Build) = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectDashboardBuild(obj: io.flow.delta.v0.models.DashboardBuild) = {
      play.api.libs.json.Json.obj(
        "project" -> jsObjectProjectSummary(obj.project),
        "name" -> play.api.libs.json.JsString(obj.name),
    ...
    def jsObjectDocker(obj: io.flow.delta.v0.models.Docker) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonReadsDeltaError: play.api.libs.json.Reads[Error] = {
      (
    ...
    def jsObjectError(obj: io.flow.delta.v0.models.Error) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesDeltaError: play.api.libs.json.Writes[Error] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.Error] {
        def writes(obj: io.flow.delta.v0.models.Error) = {
          jsObjectError(obj)
        }
      }
    }
    ...
    def jsObjectVariable(obj: io.flow.delta.v0.models.Variable) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "organization" -> jsObjectOrganizationSummary(obj.organization),
    ...
    def jsObjectVariableForm(obj: io.flow.delta.v0.models.VariableForm) = {
      play.api.libs.json.Json.obj(
        "organization" -> play.api.libs.json.JsString(obj.organization),
        "key" -> play.api.libs.json.JsString(obj.key),
        "value" -> play.api.libs.json.JsString(obj.value)
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.38 http://www.apidoc.me/flow/delta/0.3.1/play_2_4_client"
    val Version = "0.3.1"
    val VersionMajor = 0
  ...
  package errors {
    ...
    case class ErrorsResponse(
      ...
      lazy val errors = _root_.io.flow.delta.v0.Client.parseJson("Seq[io.flow.delta.v0.models.Error]", response, _.validate[Seq[io.flow.delta.v0.models.Error]])
    }
