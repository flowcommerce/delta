 ...
 * Service version: 0.2.61
 * apidoc:0.11.38 http://www.apidoc.me/flow/delta/0.2.61/play_2_4_client
 */
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.38 http://www.apidoc.me/flow/delta/0.2.61/play_2_4_client"
    val Version = "0.2.61"
    val VersionMajor = 0
    ...
    object GithubUsers extends GithubUsers {
      override def postGithub(
        ...
        _executeRequest("POST", s"/authentications/github", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw new io.flow.delta.v0.errors.ValidationErrorResponse(r)
  ...
  package errors {
    ...
    case class ValidationErrorResponse(
      ...
      lazy val validationError = _root_.io.flow.delta.v0.Client.parseJson("io.flow.error.v0.models.ValidationError", response, _.validate[io.flow.error.v0.models.ValidationError])
    }
