 ...
 * Service version: 0.5.61-45-g21c0ae1
 * apibuilder 0.14.3 app.apibuilder.io/flow/delta/0.5.61-45-g21c0ae1/play_2_6_client
 */
...
package io.flow.delta.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaSnsMessageAmi: play.api.libs.json.Reads[SnsMessageAmi] = {
      (__ \ "ECSAmis").read[io.flow.delta.v0.models.EcsAmis].map { x => new SnsMessageAmi(ECSAmis = x) }
    }
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/delta/0.5.61-45-g21c0ae1/play_2_6_client"
    val Version = "0.5.61-45-g21c0ae1"
    val VersionMajor = 0
