 ...
 * Service version: 0.7.72
 * apibuilder 0.14.59 app.apibuilder.io/flow/delta-config/0.7.72/play_2_6_client
 */
...
package io.flow.delta.config.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaConfigBuild: play.api.libs.json.Reads[Build] = {
      ...
      } yield Build(name, dockerfile, initialNumberInstances, instanceType, memory, containerMemory, portContainer, portHost, remoteLogging, stages, dependencies, version, healthcheckUrl, crossZoneLoadBalancing, allowDowntime)
    }
...
package io.flow.delta.config.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/delta-config/0.7.72/play_2_6_client"
    val Version = "0.7.72"
    val VersionMajor = 0
