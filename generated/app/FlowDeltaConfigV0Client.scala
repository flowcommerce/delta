 ...
 * apibuilder 0.14.91 app.apibuilder.io/flow/delta-config/latest/play_2_6_client
 */
...
package io.flow.delta.config.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.91 app.apibuilder.io/flow/delta-config/latest/play_2_6_client"
    val Version = "0.8.36"
    val VersionMajor = 0
