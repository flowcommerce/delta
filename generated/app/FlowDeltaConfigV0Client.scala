 ...
 * apibuilder 0.14.89 app.apibuilder.io/flow/delta-config/latest/play_2_6_client
 */
...
package io.flow.delta.config.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaConfigBuild: play.api.libs.json.Reads[Build] = {
      ...
      } yield Build(name, cluster, dockerfile, initialNumberInstances, instanceType, memory, containerMemory, portContainer, portHost, remoteLogging, stages, dependencies, version, healthcheckUrl, crossZoneLoadBalancing, allowDowntime)
    }
...
package io.flow.delta.config.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.89 app.apibuilder.io/flow/delta-config/latest/play_2_6_client"
    val Version = "0.8.14"
    val VersionMajor = 0
