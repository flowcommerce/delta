 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/delta-config/0.7.18/play_2_6_client
 */
...
package io.flow.delta.config.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/delta-config/0.7.18/play_2_6_client"
    val Version = "0.7.18"
    val VersionMajor = 0
